...
| :--- | :--- | :--- | :--- |
| **Gender Disparity Gap** (Female vs. Male FNR) | **3.06 percentage points** (FNR 13.3% vs 16.4%) | **1.67 percentage points** (FNR 15.6% vs 13.9%) | **Shrinks by 1.39 pp** (Effective sample: 106 FNs) |
| **Economic Proxy Gap** (<5 LPA vs. $\ge$5 LPA) | **0.08 percentage points** (FNR 15.1% vs 15.2%) | **1.32 percentage points** (FNR 14.2% vs 15.5%) | **Shrinks by 1.24 pp** (Effective sample: 106 FNs) |
| **First-Generation Gap** (First-Gen vs. Non-First-Gen) | **3.86 percentage points** (FNR 17.5% vs 13.6%) | **1.27 percentage points** (FNR 15.4% vs 14.1%) | **Shrinks by 2.59 pp** (Effective sample: 106 FNs) |
...
| :--- | :--- | :--- | :--- | :--- | :--- | :--- | :--- |
| **Female Students** | 845 | 47 | 35.6% | 35.1% | **84.39%** | **15.61%** | 7.90% |
| **Male Students** | 1155 | 57 | 35.4% | 35.0% | **86.06%** | **13.94%** | 6.97% |
| **Cross-Validated Disparity** | — | — | — | — | **1.67%** | **1.67%** (106 total FNs) | — |

**Interpretation**: Across the full cross-validated cohort ($106$ total False Negatives), the cross-validated FNR disparity gap is **1.67 percentage points** (Recall: 84.4% female vs. 86.1% male). This narrowing from the single-split gap (3.06 pp) is consistent with the single-split gaps being largely sampling noise, though not a formal statistical confirmation.
...
| :--- | :--- | :--- | :--- | :--- | :--- | :--- | :--- |
| **Economically Weaker (<5 LPA)** | 1206 | 66 | 38.6% | 38.3% | **85.81%** | **14.19%** | 8.50% |
| **Higher Income (>=5 LPA)** | 794 | 38 | 30.9% | 30.1% | **84.49%** | **15.51%** | 5.83% |
| **Cross-Validated Disparity** | — | — | — | — | **1.32%** | **1.32%** (106 total FNs) | — |

**Interpretation**: Economically weaker students (<5 LPA) exhibit a higher ground-truth risk base rate (38.6%), yet the cross-validated model achieves a Recall of **85.81%**, with an FNR disparity gap of only **1.32 percentage points** across the 106-FN effective sample. This observation is consistent with stable detection across income brackets without strong subgroup disparity.
...
| :--- | :--- | :--- | :--- | :--- | :--- |
| **First-Generation Learner** | 761 | 46 | 39.3% | **84.62%** | **15.38%** |
| **Non-First-Generation** | 1239 | 58 | 33.2% | **85.89%** | **14.11%** |
| **Cross-Validated Disparity** | — | — | — | **1.27%** | **1.27%** (106 total FNs) |

**Interpretation**: The cross-validated FNR disparity gap for first-generation learners is **1.27 percentage points** across the 106-FN effective sample, indicating that the larger single-split gap (3.86 pp) was likely influenced by small subgroup sample sizes.
